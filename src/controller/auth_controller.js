...
export const createAccount = async (req, res) => {
    try {
        ...
        // Create user
        const user = new User({
            first_name, last_name, gender, email: email.toLowerCase(), password: hashedPassword,
            verification: {
                otp: otp, otp_expiry: otpExpiry, is_verified: false, otp_attempts: 0, max_otp_attempts: 3,
